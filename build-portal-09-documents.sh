bash build-portal-09-documents.sh#!/usr/bin/env bash
# Adds Documents: categorized company file repository. New table + new
# Supabase Storage bucket (separate from message attachments). Everyone
# can view/download, only admin can upload/delete.
# YOU MUST: 1) run the SQL migration, 2) create a Supabase Storage bucket
# named exactly 'documents' (Public) - same steps as the 'attachments'
# bucket we made earlier.
