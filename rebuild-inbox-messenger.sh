#!/usr/bin/env bash
# Rebuilds inbox as a two-panel messenger: persistent sidebar with search,
# chat panel that switches without a full page reload. Delete removed.
...
echo "Two-panel messenger layout installed."
echo "Push to deploy: bash save-progress.sh \"Rebuild inbox as two-panel messenger\""