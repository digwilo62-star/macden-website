#!/usr/bin/env bash
# Adds Policies: card grid of company policies, click to read full text.
# Admin can Add/Edit/Delete; everyone can view. New table (text content,
# not files - distinct from Documents).
...
cat > server/routes/policies.js << 'EOF_SERVER_ROUTES_POLICIES_JS'
const express = require('express');
