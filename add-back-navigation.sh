#!/usr/bin/env bash
# Makes the logo clickable (goes to dashboard) on every page, and adds an
# explicit back-to-dashboard link on the inbox page.
...
echo "Back navigation added."
echo "Push to deploy: bash save-progress.sh \"Add back navigation to dashboard\""