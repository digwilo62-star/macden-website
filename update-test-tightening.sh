#!/usr/bin/env bash
# Updates test-tightening.js in place with the latest version (now includes
# photo upload and document version history checks). Overwrites whatever
# was there before -- no browser download needed.
