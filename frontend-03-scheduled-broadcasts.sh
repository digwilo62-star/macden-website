#!/usr/bin/env bash
# FRONTEND: Scheduled broadcasts UI (#33), wiring the backend feature
# built earlier onto the composer. Adds a Send Now / Schedule for later
# choice, and a 'Scheduled - Not Yet Sent' section on the broadcast list.
#
# Edits accounting/broadcasts.html in place -- tested against a faithful
# reconstruction of your real file before being sent, and confirmed
# safe to run more than once.
#
# Run this from the ROOT of your macden-website repo, in Git Bash.
set -e

cat > fix-scheduled-broadcasts.js << 'EOF_FIXER_JS'
...
echo "Running the patcher on broadcasts.html..."
node fix-scheduled-broadcasts.js
echo ""
echo "Done. Restart your server and test scheduling a broadcast."