// test-supabase-speed.js
//
// Tests the OTHER connection path -- the Supabase JS client (used for
// almost all your actual business data: announcements, staff, attendance)
// which is completely separate from the pg Pool we already fixed. This
// checks whether repeated calls, with a realistic pause between them,
// keep paying full connection-setup cost each time.
