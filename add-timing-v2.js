...
if (!content.includes(oldBlock)) {
  console.error('ERROR: exact block (part 1) not found. Nothing changed.');
  process.exit(1);
}
...
if (!content.includes(oldRegen)) {
  console.error('ERROR: exact block (part 2, regenerate) not found. Part 1 WAS applied -- file is now partially changed. Send Claude the current file content.');
