#!/usr/bin/env bash
# Adds Staff Directory (searchable list + profile modal). Shows what's
# real (name, role, department, email, date joined) and honestly labels
# what isn't built yet (phone, branch) as 'Not yet added' rather than
# faking it. Message button jumps to Compose with the recipient pre-filled.
