#!/usr/bin/env bash
# Surfaces the REAL upload error (instead of a generic message), and fixes
# the error banner never clearing - now dismissible and auto-clears on
# successful send or chat switch.
      ...
      <div class="chat-shell">
        ...
        <div class="chat-panel">
          ...
          <div id="activeChat" style="display: none; flex-direction: column; flex: 1;">
            ...
            <div id="attachmentAlert" class="alert alert-error" style="margin: 8px 18px 0; display: none; align-items: center; justify-content: space-between;">
              <span id="attachmentAlertText"></span>
              <button onclick="hideAlert(document.getElementById('attachmentAlert'))" style="background: none; border: none; color: inherit; cursor: pointer; font-size: 13px; padding: 0 0 0 12px;">✕</button>
            </div>
...
echo "Upload error now shows the real reason, and clears properly."
echo "Push to deploy: bash save-progress.sh \"Fix upload error visibility and persistence\""