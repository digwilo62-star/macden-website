#!/bin/bash
# fix-address-phone-v1.sh
#
# Three changes to the ID card:
#   1. Company contact number updated to +234 904 211 7497
#   2. Head office address updated to:
#        4, Wempco Road,
#        Ogba, Lagos state.
#   3. Employee phone now formatted "+234 XXX XXX XXXX" -- same spacing
#      as the company number (was previously showing as one unbroken
#      string like +2348039990776).
#
