...
# other two placeholders with ONE real, role-appropriate card. FIXED
# VERSION -- the first attempt had a whitespace bug in its own search
# pattern (my mistake, not your file), caught by testing against your
# exact real file content this time before sending.
set -e
